                                    ...
                                    <div className="row">
                                        <div className="col-md-4 mb-3">
                                            <div className="card carousel-color">
                                                <img
                                                    ...
                                                    alt="100%x280"
                                                    src="/img/refrigeracion-comercial.webp"
                                                />
                                                <div className="carousel-color">
                                                    <h3 className="card-title">REFRIGERACIÓN COMERCIAL</h3>
                                        ...
                                        <div className="col-md-4 mb-3">
                                            <div className="card carousel-color">
                                                <img
                                                    className="img-fluid heightCursos"
                                                    alt="100%x280"
                                                    src="/img/electricidad.webp"
                                                />
                                                <div className="carousel-color">
                                                    <h4 className="card-title">ELECTRICIDAD EN LA REFRIGERACION</h4>
                                                    {/* <Button size="lg" className="button botones">
                                                        Quiero saber más
                                                    </Button> */}
                                                </div>
                                        ...
                                        <div className="col-md-4 mb-3">
                                            <div className="card carousel-color">
                                                ...
                                                />
                                                <div className="carousel-color">
                                                    <h4 className="card-title">AIRE ACONDICIONADO FAMILIAR</h4>
                                                    {/* <Button size="lg" className="button botones">
                                                        Quiero saber más
                                                    </Button> */}
                                                </div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-4 mb-3">
                                            <div className="card carousel-color">
                                                ...
                                                />
                                                <div className="carousel-color">
                                                    <h4 className="card-title">CURSO ELECTRÓNICA LINEA BLANCA</h4>
                                                    <Button size="lg" className="button botones">
                                                        Quiero saber más
                                                    </Button>
                                                </div>
